...
#define	SECTOR_ADM	252	        
#define FTM_PRECISON 10000     //定义占空比精度，100即精度为1%，1000u则精度为0.1%，用于占空比 duty 形参传入，即占空比为 duty/FTM_PRECISON


#define  Beer_ON          gpio_init (PTG2,1,1);
#define  Beer_OFF         gpio_init (PTG2,1,0);
#define SteerMid 1520
#define GOAL_SPEED 0
#define TURN_MAX 130
#define CH1        ad[0]
#define CH2        ad[1] 
